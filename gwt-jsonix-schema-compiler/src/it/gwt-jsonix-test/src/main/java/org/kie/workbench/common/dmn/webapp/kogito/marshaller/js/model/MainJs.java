...
public class MainJs {
    ...
    @JsMethod
    public final static native void unmarshall(String xmlString, KIEUnmarshallCallback kIEUnmarshallCallback);

    @JsMethod
    public final static native void marshall(KIE kIE, KIEMarshallCallback kIEMarshallCallback);
